...
dictionary = {
    ...
    'supo': ['serupa', 'seperti'],
    'isley': ['islam'],
    'berapa yah': ['berapa ringgit'],
    'klate': ['kelantan'],
    'kelate': ['kelantan'],
    'toksoh': ['tidak perlu', 'tidak usah'],
    'lagu ni deh': ['seperti ini'],
    'dengey': ['dengan'],
    'ore': ['orang'],
    'gocoh': ['gaduh'],
    'nok': ['nak'],
    ...
    'ketik': ['tekan'],
    'hokaloh': ['ya lah'],
    'buwak lagu': ['buat seperti'],
    'kecek derek': ['terus terang'],
    'bo la wey': ['sudah lah'],
    'bo la weh': ['sudah lah'],
    'bo la': ['sudah lah'],
    'tuhe': ['tuhan'],
    'molek jek': ['baik-baik sahaja'],
    'dio': ['dia'],
    'pranga': ['perangai'],
    'loleh': ['buruk'],
    'tkpehei': ['tak faham'],
