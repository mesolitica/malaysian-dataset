base_instruction = "I want you act as a Malay Prompt Rewriter.\r\n \
					Your objective is to rewrite a given prompt into malay language, a more complex version and hyperlocal for malaysia if possible to make those famous AI systems (e.g., chatgpt and GPT4) a bit harder to handle.\r\n \
