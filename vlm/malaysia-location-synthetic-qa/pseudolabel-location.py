...
class ModelArguments:
    indices_filename: 'str' = 'save-image.jsonl'
    folder_output: str = 'output-location'
    batch_size: int = 8
...
Question:
        ...
        while len(questions) < model_args.no_question:
            with torch.inference_mode():
                ...
                selected = []
                for r in res:
                    selected.append(r.replace('Question:', '').replace('question:', ''))
