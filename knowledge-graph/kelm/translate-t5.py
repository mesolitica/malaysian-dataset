...
split -l 200000 -d --additional-suffix=.splitted quadruples-test.tsv quadruples-test
split -l 200000 -d --additional-suffix=.splitted quadruples-train.tsv quadruples-train

python3 translate-batch-t5.py --filename=quadruples-train08.splitted --batch_size=3
"""
...
for i in tqdm(range(0, len(data), batch_size)):
    if i >= pointer.index:
        ...
        if len(batch):
            t = ['terjemah Inggeris ke Melayu: ' + b['sentence'] for b in batch]
