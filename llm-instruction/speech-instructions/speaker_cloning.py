# https://github.com/Zyphra/Zonos/blob/main/zonos/speaker_cloning.py
...
class SpeakerEmbedding(nn.Module):
    def __init__(self, device: str = "cuda"):
        ...
        with torch.device(device):
            ...
            ckpt_path = hf_hub_download(repo_id="Zyphra/Zonos-v0.1-speaker-embedding", filename="ResNet293_SimAM_ASP_base.pt")
