...
- website: `bikesrepublic <https://www.bikesrepublic.com/>`__
...
1. `foodpanda-city.json <foodpanda-city.json>`__,
...
2. `foodpanda-restaurant.json <foodpanda-restaurant.json>`__,
...
3. `foodpanda-foods-old.json <https://f000.backblazeb2.com/file/malay-dataset/crawler/foodpanda/foodpanda-foods-old.json>`__,
...
4. `foodpanda-foods.json <https://f000.backblazeb2.com/file/malay-dataset/crawler/foodpanda/foodpanda-foods.json>`__,
...
* website: `leaazleeya <https://www.leaazleeya.com/>`__
* num. of webpages: 544
...
* Primary school textbook: `KSSR <https://www.ipendidikan.my/buku-teks-digital-kssr-tahun-1-hingga-6.html>`__
* Secondary school textbook: `KSSM <https://www.ipendidikan.my/koleksi-buku-teks-digital-asas-kssm.html>`__
* Link to dataset on `Huggingface <https://huggingface.co/datasets/haizad/malaysia-textbook/>`__
...
* Laman sesawang: `mat-gaming <https://mat-gaming.com/>`__
* Jumlah muka laman: 6
...
* Laman sesawang: `motor-malaya <https://motomalaya.net/blog/>`__
...
1. Put necessary urls in `list.txt <list.txt>`__.
2. Run `run.py <run.py>`__,
...
* website: `techrakyat <https://techrakyat.com/>`__
...
* website: `theedgemalaysia <https://theedgemalaysia.com/>`__
...
- website: `timchew <https://timchew.net/>`__
...
- website: `Vikatan-MY <https://www.vikatan.com/topics/malaysia>`__
